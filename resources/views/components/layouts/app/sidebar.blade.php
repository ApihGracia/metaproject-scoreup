        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                ...
                @elseif ($currentUser->hasRole('technician'))
                    ...
                    <flux:navlist.group :heading="__('Technician Tools')" class="grid">
                        <flux:navlist.item icon="home" :href="route('technicianrule')" :current="request()->routeIs('technicianrule')" wire:navigate>{{ __('Rules') }}</flux:navlist.item>
                        <flux:navlist.item icon="home" :href="route('technicianschedule')" :current="request()->routeIs('technicianschedule')" wire:navigate>{{ __('Schedule') }}</flux:navlist.item>
